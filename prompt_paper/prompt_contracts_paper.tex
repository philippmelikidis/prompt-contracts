...
\footnotesize
\begin{tabular}{@{}p{2.5cm}p{1.2cm}p{1.2cm}p{1.8cm}p{1.2cm}p{1.2cm}@{}}
\toprule
\textbf{Metric} & \textbf{Value} & \textbf{Method} & \textbf{95\% CI} & \textbf{Source} & \textbf{Ver.} \\
\midrule
...
\label{tab:results}
\footnotesize
\begin{tabular}{@{}p{2.2cm}p{1.2cm}p{1cm}p{1.2cm}p{1cm}p{1.2cm}p{1cm}@{}}
\toprule
...
\end{tabular}
\vspace{1mm}
\footnotesize\(^*\)OH\% = Overhead\% = (check execution time / total latency) \(\times\) 100
\end{table}
...
\label{tab:live_eval}
\footnotesize
\begin{tabular}{@{}p{2.2cm}p{2.2cm}p{1.2cm}p{1.2cm}p{1.2cm}p{1.2cm}p{1.2cm}@{}}
\toprule
